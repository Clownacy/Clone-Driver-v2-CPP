...
namespace SMPS
{
	...
	enum
	{
		NON_BACKUP_TRACKS_BEGIN = MUSIC_DAC,
		...
		NON_BACKUP_TRACKS_END,
		NON_BACKUP_TRACK_COUNT = NON_BACKUP_TRACKS_END - NON_BACKUP_TRACKS_BEGIN
	};

	enum
	{
		MUSIC_FM_BEGIN = MUSIC_FM1,
		MUSIC_FM_END = MUSIC_FM6 + 1,
		MUSIC_FM_TRACK_COUNT = MUSIC_FM_END - MUSIC_FM_BEGIN,

		MUSIC_FM_DAC_BEGIN = MUSIC_DAC,
		MUSIC_FM_DAC_END = MUSIC_FM6 + 1,
		MUSIC_FM_DAC_TRACK_COUNT = MUSIC_FM_DAC_END - MUSIC_FM_DAC_BEGIN,

		MUSIC_PSG_BEGIN = MUSIC_PSG1,
		MUSIC_PSG_END = MUSIC_PSG3 + 1,
		...
		SFX_FM_END = SFX_FM5 + 1,
		SFX_FM_TRACK_COUNT = SFX_FM_END - SFX_FM_BEGIN,

		SFX_PSG_BEGIN = SFX_PSG1,
		SFX_PSG_END = SFX_PSG3 + 1,
		SFX_PSG_TRACK_COUNT = SFX_PSG_END - SFX_PSG_BEGIN,

		SFX_BEGIN = SFX_FM_BEGIN,
		SFX_END = SFX_PSG_END,
		SFX_TRACK_COUNT = SFX_END - SFX_BEGIN,

	#ifdef SMPS_EnableSpecSFX
		SPECIAL_SFX_FM_BEGIN = SPECIAL_SFX_FM4,
		SPECIAL_SFX_FM_END = SPECIAL_SFX_FM4 + 1,
		SPECIAL_SFX_FM_TRACK_COUNT = SPECIAL_SFX_FM_END - SPECIAL_SFX_FM_BEGIN,

		SPECIAL_SFX_PSG_BEGIN = SPECIAL_SFX_PSG3,
		SPECIAL_SFX_PSG_END = SPECIAL_SFX_PSG3 + 1,
		SPECIAL_SFX_PSG_TRACK_COUNT = SPECIAL_SFX_PSG_END - SPECIAL_SFX_PSG_BEGIN,

		SPECIAL_SFX_BEGIN = SPECIAL_SFX_FM4,
		SPECIAL_SFX_END = SPECIAL_SFX_PSG3 + 1,
